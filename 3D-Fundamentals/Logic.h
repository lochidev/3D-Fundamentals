...
public:
    Logic(SDL_Renderer* renderer, const std::string& imagePath, int x, int y, int width, int height, SDL_Color color = { 255, 255, 255, 255 })
        : renderer(renderer), texture(nullptr), width(width), height(height), color(color), selected(false) {
...
public:
    OR(SDL_Renderer* renderer, int x, int y, int width, int height, SDL_Color color = { 255, 255, 0, 255 })
...
public:
    XOR(SDL_Renderer* renderer, int x, int y, int width, int height, SDL_Color color = { 255, 255, 0, 255 })
